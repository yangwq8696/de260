#ifndef FORM_CONTROLPORT2_H
#define FORM_CONTROLPORT2_H
...
namespace Ui {
class FORM_ControlPort2;
}

class FUN_MeterFinger;
class wika_GeneralWidget;
class FORM_ControlPort2 : public Page
{
    Q_OBJECT

public:
    explicit FORM_ControlPort2(Page *parent = nullptr);
    ~FORM_ControlPort2();
    void showForm();
    void closeForm();
private slots:
