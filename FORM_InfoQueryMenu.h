#ifndef FORM_INFOQUERYMENU_H
#define FORM_INFOQUERYMENU_H
...
namespace Ui {
class FORM_InfoQueryMenu;
}

class FUN_MeterFinger;
class wika_GeneralWidget;
class FORM_InfoQueryMenu : public Page
{
    Q_OBJECT

public:
    explicit FORM_InfoQueryMenu(Page *parent = nullptr);
    ~FORM_InfoQueryMenu();
    void showForm();
    void closeForm();
private slots:
