/*
 * Generated by mgmtTool
 * Time: 2019-10-21 09:58:35
 */

#ifndef __CANVARS_CAN0_H
#define __CANVARS_CAN0_H

#define VAR_BIT_FLAG            0x1000000   //
#define VAR_BIT_MASK            0x0ff0000   // VAR变量格式：0xAABBBB,其中AA表示第几bit位; BBBB表示Var的序号
#define VAR_BIT_SHIFT           16          // 如VAR变量0x060009表示Var=9的bit6
#define VAR_VAR_MASK            0x000ffff   //
#define VAR_VAR_SHIFT           0           //
#define VAR_BIT(_var, _bit)     (VAR_BIT_FLAG | ((_var)<<VAR_VAR_SHIFT) | ((_bit)<<(VAR_BIT_SHIFT))) //
